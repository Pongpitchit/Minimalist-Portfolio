import { Mail, GraduationCap, ScrollText, MapPin } from 'lucide-react'
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-3 md:gap-4">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 ">
            <p className="text-xs text-muted-foreground uppercase mb-1">Studying at</p>
            <a
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <p className="text-xs text-muted-foreground uppercase mb-1">Faculty of</p>
            <p className="text-sm text-foreground">{data.Faculty}</p>
          </div>
        </div> 
